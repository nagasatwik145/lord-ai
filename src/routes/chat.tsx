...
function ChatPage() {
  ...
  return (
    <AppShell>
      <div className="mx-auto flex h-[calc(100vh-9rem)] max-w-4xl flex-col gap-4 md:h-[calc(100vh-7rem)]">
        {/* Mode selector */}
        <div className="hud-panel flex flex-wrap items-center gap-1 p-2">
