            ...
            >
              ...
              {editingId === c.id ? (
                <div className="flex flex-1 items-center gap-1">
                  ...
                  />
                  <Check className="h-3.5 w-3.5 cursor-pointer hover:text-primary" onClick={(e) => saveEdit(c.id, e)} />
                  <X className="h-3.5 w-3.5 cursor-pointer hover:text-destructive" onClick={(e) => { e.stopPropagation(); setEditingId(null); }} />
                </div>
              ) : (
              ...
              <div className="absolute right-2 hidden items-center gap-1 group-hover:flex">
                <Edit2 className="h-3.5 w-3.5 cursor-pointer hover:text-primary" onClick={(e) => startEdit(c.id, c.title, e)} />
                <Trash2 className="h-3.5 w-3.5 cursor-pointer hover:text-destructive" onClick={(e) => handleDelete(c.id, e)} />
              </div>
            </div>
          ))}
        </div>
